...
- [x] Create landing page with header, footer, hero section, and put CTA to login/register. In header, keep the logo (you can generate an appropriate one), login and register link.
In hero section, keep a heading about the website, a sub-heading, and CTA to login/register.
