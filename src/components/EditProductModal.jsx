...
import { X, Calendar, Package, Tag, Hash, FileText, AlertCircle, Loader2, CheckCircle2 } from 'lucide-react';
...
const EditProductModal = ({ isOpen, onClose, product, onUpdateProduct }) => {
  ...
  useEffect(() => {
    if (product) {
      ...
      setBarcode(product.barcode || product.upcCode || '');
        ...
        <div className="px-6 py-5 border-b border-gray-100 flex items-center justify-between bg-gradient-to-r from-blue-50/50 to-indigo-50/50">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 font-medium">Update details or mark product status</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-6 overflow-y-auto space-y-4 flex-1">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <div className="relative">
                <CheckCircle2 className="w-4 h-4 text-gray-400 absolute left-3.5 top-1/2 -translate-y-1/2" />
                <select
                  value={status}
